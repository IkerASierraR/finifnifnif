...
INSERT INTO `administrativo` (`IdAdministrativo`, `IdUsuario`, `Turno`, `Extension`, `FechaIncorporacion`) VALUES
	(1, 15, 'Mañana', '98764635', '2025-11-09');
...
INSERT INTO `usuario` (`IdUsuario`, `Nombre`, `Apellido`, `TipoDoc`, `NumDoc`, `Rol`, `Celular`, `Genero`, `Estado`, `FechaRegistro`) VALUES
	...
	(15, 'pablo', 'neruda', 2, '872346812', 3, '762394581', b'0', 1, '2025-11-09 12:15:04'),
...
-- Volcando datos para la tabla sisintupt.usuario_auth: ~4 rows (aproximadamente)
INSERT INTO `usuario_auth` (`IdAuth`, `IdUsuario`, `CorreoU`, `Password`, `UltimoLogin`) VALUES
	(6, 14, 'ike@upt.pe', 'MTIzNDU2', NULL),
	(7, 15, 'pa@upt.pe', 'MTIzNDU2', NULL),
	(8, 16, 'dn@upt.pe', 'MTIzNA==', NULL),
	(9, 17, 'ju@upt.pe', 'MTIzNDU2', NULL);
